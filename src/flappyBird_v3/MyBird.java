...
public class MyBird extends JPanel {
	...
	public MyBird() throws Exception {
		...
		backMusic = new Sound("backMusic.wav");
		hitM = new Sound("hit.wav");
		flappyM = new Sound("flappy.wav");
		startM = new Sound("start.wav");
		scoreM = new Sound("score.wav");
		start();
	}
	public void start(){
		try {
